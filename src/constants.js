...
const hipercardPrefixes6 = new Set(['606282']);

const discoverPrefixes6 = new Set();
for (let i = 622126; i <= 622925; i++) {
  discoverPrefixes6.add(i.toString());
}
const discoverPrefixes4 = new Set(['6011']);
const discoverPrefixes3 = new Set(['644', '645', '646', '647', '648', '649']);
const discoverPrefixes2 = new Set(['65']);

const jcbPrefixes4 = new Set();
for (let i = 3528; i <= 3589; i++) {
  jcbPrefixes4.add(i.toString());
}

const mastercardPrefixes4 = new Set();
for (let i = 2221; i <= 2720; i++) {
  mastercardPrefixes4.add(i.toString());
}
const mastercardPrefixes2 = new Set(['51', '52', '53', '54', '55']);

const dinersPrefixes3 = new Set(['300', '301', '302', '303', '304', '305']);
const dinersPrefixes2 = new Set(['36', '38', '39']);
...
export const cardBrandRules = [
  ...
  { brand: 'hipercard', prefixes: hipercardPrefixes6, length: 6 },
  { brand: 'discover', prefixes: discoverPrefixes6, length: 6 },
  { brand: 'elo', prefixes: eloPrefixes5, length: 5 },
  { brand: 'elo', prefixes: eloPrefixes4, length: 4 },
  { brand: 'jcb', prefixes: jcbPrefixes4, length: 4 },
  { brand: 'mastercard', prefixes: mastercardPrefixes4, length: 4 },
  ...
  { brand: 'mastercard', prefixes: mastercardPrefixes2, length: 2 },
